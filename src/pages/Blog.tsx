...
import { getBlogs, BlogPost } from '@/lib/blogStorage';
    ...
    useEffect(() => {
        ...
        const fetchBlogs = async () => {
            try {
                ...
                console.log("Merged blogs to render:", blogs);
                if (isMounted) setBlogPosts(blogs);
            } catch (error) {
                    ...
                    {loading ? (
                        <div className="flex justify-center items-center py-32 min-h-[50vh]">
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <p className="text-muted-foreground font-medium animate-pulse">Loading articles...</p>
                            </div>
                        </div>
                    ) : (
